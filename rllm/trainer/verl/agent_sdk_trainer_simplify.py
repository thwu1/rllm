...
class AgentSdkTrainer(RayPPOTrainer):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    batch = self._pad_dataproto_to_world_size(batch=new_batch)
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        # TODO: The correspondint change fixed the problem of unfair advantage calculation because each trajectory might have different number of steps,
                        # if index by uid, the one with more steps will have more advantages, which is not correct.
                        # e.g. if trajectory 1 has 2 steps with reward 1, and trajecotory 2 have 1 step with reward 0
                        # then mean will be calculated as 2/3, which should be 1/2 instead.
    ...
    def compute_grpo_advantage(
        ...
        advantages, returns = compute_grpo_outcome_advantage(
            ...
            traj_uuids=data.non_tensor_batch["traj_uuids"],
            index=data.non_tensor_batch["trajectory_ids"],
