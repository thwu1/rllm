...
def prepare_countdown_data():
    ...
    # Register datasets
    train_dataset = DatasetRegistry.register_dataset("countdown", train_dataset.to_list(), "train")
    test_dataset = DatasetRegistry.register_dataset("countdown", test_dataset.to_list(), "test")
    stage2_dataset = DatasetRegistry.register_dataset("countdown", stage2_dataset.to_list(), "stage2_train")
    stage3_dataset = DatasetRegistry.register_dataset("countdown", stage3_dataset.to_list(), "stage3_train")
