...
if __name__ == "__main__":
    ...
    model_name = "accounts/rllm-project/deployedModels/ft-mhl9udc7-jua7s-s0uvss0w"
    # model_name = "accounts/rllm-project/deployedModels/qwen2-7b-instruct-fuismmix"
    ...
    engine = AgentExecutionEngine(
        ...
        env_args=env_args,
        engine_name="openai",
        rollout_engine_args={"base_url": "https://api.fireworks.ai/inference/v1", "api_key": "fw_3ZYDcBgbAJZ7kfAhorvPSKbn", "model": model_name},
        tokenizer=tokenizer,
